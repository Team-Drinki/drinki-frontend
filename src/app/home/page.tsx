...
export default function Home() {
  ...
  const hotCommunityPosts = data?.hotCommunityPosts?.length
    ? data.hotCommunityPosts
    : communityPosts;
    ...
    <div className="flex-1 w-full">
      ...
      <main className="mx-auto my-10 flex w-full max-w-[1200px] flex-col gap-12 px-4 md:my-14 md:gap-16 md:px-6 lg:px-8">
        <section>
          <Link
            href="/tasting-note"
            className="inline-block rounded-sm focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-yellow-main"
          >
            <Title className="mb-5 transition-opacity hover:opacity-70">
