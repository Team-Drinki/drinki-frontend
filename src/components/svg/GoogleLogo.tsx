  ...
  return (
    <SvgWrapper className={cn('size-5', className)}>
      <g clipPath="url(#clip0_3900_934)">
        ...
        />
        <path
          d="M5.50277 14.3007C5.00011 12.8103 5.00011 11.1965 5.50277 9.70618V6.61523H1.51674C-0.185266 10.006 -0.185266 14.0009 1.51674 17.3916L5.50277 14.3007V14.3007Z"
          fill="#FBBC04"
        />
        <path
